...
from project.model.unrolling import UnrolledPrecompensationNet
from project.model.unrolling import apply_filter
...
def evaluate(
    model: UnrolledPrecompensationNet,
...
def build_final_report(
    ...
    rows = [
        ...
        ("Ours (Unrolling)", summarize_metric(ours_ssim), summarize_metric(ours_psnr), summarize_metric(ours_lpips)),
    ]
...
def run_experiment(config: ExperimentConfig) -> None:
    ...
    model = UnrolledPrecompensationNet(config, psf_tensor).to(device)
