...
from project.model.unrolling_jorge import JorgeADMMUnrollingNet, apply_filter
...
def build_final_report(
    ...
    rows = [
        ...
        ("Ours (Jorge-ADMM)", summarize_metric(ours_ssim), summarize_metric(ours_psnr), summarize_metric(ours_lpips)),
    ]
...
def run_experiment_jorge(config: ExperimentConfig) -> None:
